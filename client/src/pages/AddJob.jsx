...
const ApplyJob = () => {
  ...
  // NOTE: Added fetchUserData to the destructuring here
  ...
  const applyHandler = async () => {
    try {
      ...
      // Check 1: Get Clerk Token (most reliable check for logged in status)
      ...
      // Check 2: Application Data Load (handles the race condition)
      if (!userData) {
